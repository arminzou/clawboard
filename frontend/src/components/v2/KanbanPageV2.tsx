    ...
    <div className="h-full">
      <div className="flex h-full">
        ...
        <main className="min-w-0 flex-1">
          ...
          <div className="h-[calc(100%-56px)] px-4 py-4">
            ...
            {!loading && visibleTasks.length === 0 ? (
              <div className="rounded-xl border border-slate-200 bg-white p-3 text-sm text-slate-700">No tasks match your filters.</div>
            ) : null}
