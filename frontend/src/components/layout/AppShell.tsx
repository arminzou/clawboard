...
export function AppShell({
  ...
  useEffect(() => {
    if (!hasSidebar || typeof window === 'undefined') return;
    ...
    <div className="flex h-full">
      {hasSidebar ? (
        <>
          ...
          <div
            className={clsx(
              'fixed inset-y-0 left-0 z-50 w-72 transform border-r border-[rgb(var(--cb-border))] bg-[rgb(var(--cb-surface))] transition-transform lg:static lg:translate-x-0 lg:transition-[width]',
